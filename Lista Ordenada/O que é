...
Suponha a lista a seguir com os seguintes valores:
...
A Figura 14 ilustra a inserção desse novo nó na lista apresentada inicialmente. Observe que esse deve ser inserido entre os nós aux, com o valor 40, e o último nó, que contém o valor 55.
...
A utilização dessa estrutura de dados no desenvolvimento de jogos é importante para situações nas quais a ordem dos elementos é importante para a lógica e para
